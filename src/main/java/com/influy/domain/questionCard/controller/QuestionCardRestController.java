...
import com.influy.domain.questionCard.converter.QuestionCardConverter;
...
import com.influy.domain.questionCard.service.QuestionCardService;
...
public class QuestionCardRestController {
    ...
    public ApiResponse<QuestionCardResponseDto.PageDto> getPage(@PathVariable("sellerId") Long sellerId,
        ...
        Page<QuestionCard> questionCardPage = questionCardService.getPage(sellerId, itemId, faqCategoryId, pageNumber);
        return ApiResponse.onSuccess(QuestionCardConverter.toPageDto(questionCardPage));
    }
}

...
public class QuestionCategoryController {
    ...
    public ApiResponse<QuestionCategoryResponseDTO.General> createCategory(@PathVariable Long itemId,
    ...
    public ApiResponse<QuestionCategory> getCategoriesAnd2Question(@PathVariable Long itemId) {
        return null;
    }
    ...
    public ApiResponse<QuestionCategory> updateCategory(@PathVariable Long itemId) {
        return null;
    }
    ...
    public ApiResponse<QuestionCategory> deleteCategory(@PathVariable Long itemId) {
        return null;
    }
